...
if hud.active_card="Spot Roll" and (hud.score_dice_A=6 or hud.score_dice_B=6) {store.append_score+=4500*(hud.active_card_lvl*hud.active_card_lvl) instance_create_depth(210,600,depth,effect_show_cardresult).myText="$"+calc_number(4500*(hud.active_card_lvl*hud.active_card_lvl))}
if hud.active_card="Double Up" and (hud.score_dice_A=hud.score_dice_B) {store.append_score+=6000*(hud.active_card_lvl*hud.active_card_lvl) instance_create_depth(210,600,depth,effect_show_cardresult).myText="$"+calc_number(6000*(hud.active_card_lvl*hud.active_card_lvl))}
