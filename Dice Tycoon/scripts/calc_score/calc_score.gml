...
function calc_score(){
//Calc Score
hud.score_add=hud.score_dice_A+hud.score_dice_B //Add Dice together
if hud.score_dice_A=hud.score_dice_B {hud.score_add*=store.doubles_multiplier instance_create_depth(208,396,depth,effect_show_text).myText="Doubles!"} //Multiply by Doubles multiplier
...
if store.critical_chance>random(100) {hud.score_add*=store.critical_multiplier instance_create_depth(199,410,depth,effect_show_text).myText="Critical Roll!"} //Critical Roll
