...
if store.cardA="Restock" {store.cardA_desc="Roll a 1 or 3\nGain "+string(1+(1*store.cardA_lvl))+" Cards on roll."}
if store.cardB="Restock" {store.cardB_desc="Roll a 1 or 3\nGain "+string(1+(1*store.cardB_lvl))+" Cards on roll."}
if store.cardC="Restock" {store.cardC_desc="Roll a 1 or 3\nGain "+string(1+(1*store.cardC_lvl))+" Cards on roll."}

if store.cardA="Lump Sum" {store.cardA_desc="Earn $"+string(300*(store.cardA_lvl*store.cardA_lvl))+" on roll."}
if store.cardB="Lump Sum" {store.cardB_desc="Earn $"+string(300*(store.cardB_lvl*store.cardB_lvl))+" on roll."}
if store.cardC="Lump Sum" {store.cardC_desc="Earn $"+string(300*(store.cardC_lvl*store.cardC_lvl))+" on roll."}
...
if store.cardA="Spot Roll" {store.cardA_desc="Roll a Six to earn $"+string(4500*(store.cardA_lvl*store.cardA_lvl))}
if store.cardB="Spot Roll" {store.cardB_desc="Roll a Six to earn $"+string(4500*(store.cardB_lvl*store.cardB_lvl))}
if store.cardC="Spot Roll" {store.cardC_desc="Roll a Six to earn $"+string(4500*(store.cardC_lvl*store.cardC_lvl))}
	
if store.cardA="Double Up" {store.cardA_desc="Roll doubles to earn $"+string(6000*(store.cardA_lvl*store.cardA_lvl))}
if store.cardB="Double Up" {store.cardB_desc="Roll doubles to earn $"+string(6000*(store.cardB_lvl*store.cardB_lvl))}
if store.cardC="Double Up" {store.cardC_desc="Roll doubles to earn $"+string(6000*(store.cardC_lvl*store.cardC_lvl))}
