...
if store.lvl_totalmultiplier>70 {store.cost_totalmultiplier +=store.lvl_totalmultiplier*20}
if store.lvl_totalmultiplier>100 {store.cost_totalmultiplier +=store.lvl_totalmultiplier*50}
...
if store.lvl_totalmultiplier>50 {store.cost_totalmultiplier +=store.lvl_totalmultiplier*50}
if store.lvl_totalmultiplier>70 {store.cost_totalmultiplier +=store.lvl_totalmultiplier*100}
if store.lvl_totalmultiplier>100 {store.cost_totalmultiplier +=store.lvl_totalmultiplier*250}
