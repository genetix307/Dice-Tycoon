...
store.cost_critical_multiplier +=store.lvl_critical_multiplier*100
if store.lvl_critical_multiplier>15 {store.cost_critical_multiplier+=250*round(store.lvl_critical_multiplier/5)}
...
store.cost_critical_multiplier +=store.lvl_critical_multiplier*500
if store.lvl_critical_multiplier>15 {store.cost_critical_multiplier+=2500*round(store.lvl_critical_multiplier)}
