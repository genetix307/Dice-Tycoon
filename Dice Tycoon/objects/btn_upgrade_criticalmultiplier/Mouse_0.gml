...
store.cost_critical_multiplier +=store.lvl_critical_multiplier*1500
if store.lvl_critical_multiplier>10 {store.cost_critical_multiplier+=250*round(store.lvl_critical_multiplier)}
...
store.cost_critical_multiplier +=store.lvl_critical_multiplier*7500
if store.lvl_critical_multiplier>10 {store.cost_critical_multiplier+=2500*round(store.lvl_critical_multiplier*5)}
